    ...
    return (
      <footer className="container mt-10 flex flex-col items-center justify-between gap-6 py-10 sm:flex-row">
        ...
        <div className="flex items-center gap-5">
          <a href="https://github.com/tomw1808/mkdocs-shadcn" className="text-muted-foreground hover:text-foreground">
            <GitHubLogoIcon />
          </a>
          <a href="https://thomaswiesner.com" className="text-muted-foreground hover:text-foreground">
            <PersonIcon />
          </a>
        </div>
      </footer>
